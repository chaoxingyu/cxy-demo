...
public class Date4OldUtil {
     ...
     * @throws ParseException
     */
    public static long compareTime(String startDate, String endDate, String dateFormat) throws ParseException {
    ...
    public static void main(String[] args) {
        System.out.println(Date4OldUtil.getNowStrDate("yyyyMMddHHmmssSSS"));
        String str = "20170123";
